...
url0 = LINK_BASE + 'forum-56-{}.html'.format(START_PAGE)
...
fname = 'lncn_thread-{}_{}.csv'.format(START_PAGE, now)
...
url = LINK_BASE + 'forum-56-{}.html'.format(1)

# 爬取所有页面
for i in range(START_PAGE, 218):
    slp_time = random.randint(7, 17)
    print('\nwill sleep[', slp_time, '] s')
    time.sleep(slp_time)
    url = LINK_BASE + 'forum-56-{}.html'.format(i)
    # print(url)
