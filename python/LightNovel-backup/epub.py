...
url0 = LINK_BASE + 'forum-194-{}.html'.format(START_PAGE)
...
fname = 'lncn-epub_thread-{}_{}.csv'.format(START_PAGE, now)
...
url = LINK_BASE + 'forum-194-{}.html'.format(1)

# 爬取所有页面
for i in range(START_PAGE, END_PAGE+1):
    slp_time = random.randint(1, 5)
    print('\nwill sleep[', slp_time, '] s')
    time.sleep(slp_time)
    url = LINK_BASE + 'forum-194-{}.html'.format(i)
    # print(url)
